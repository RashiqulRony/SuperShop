<a href="{{url('/offer')}}"><img src="{{asset('/front')}}/images/download.png" class="img-head" alt=""></a>
<div class="header">
    ...
    <div class="container">
        ...
        <div class="head-t">
            <ul class="card">
                ...
                <li><a href="{{url('/signin')}}" ><i class="fa fa-user" aria-hidden="true"></i>Sign In</a></li>
                <li><a href="{{url('/user-register')}}" ><i class="fa fa-arrow-right" aria-hidden="true"></i>Register</a></li>
                <li><a href="{{url('/about')}}" ><i class="fa fa-file-text-o" aria-hidden="true"></i>About Us</a></li>
                            ...
                            <ul class="dropdown-menu multi">
                                <div class="row">
                                    ...
                                    <div class="col-sm-3 w3l">
                                        <a href="{{url('/kitchen')}}"><img src="{{asset('/front')}}/images/me.png" class="img-responsive" alt=""></a>
                                    </div>
                        ...
                        <li class="dropdown">
                            ...
                            <ul class="dropdown-menu multi multi1">
                                <div class="row">
                                    ...
                                    <div class="col-sm-3 w3l">
                                        <a href="{{url('/care')}}"><img src="{{asset('/front')}}/images/me1.png" class="img-responsive" alt=""></a>
                                    </div>
                                    <div class="clearfix"></div>
                                </div>
                            </ul>
                        ...
                        <li class="dropdown">
                            ...
                            <ul class="dropdown-menu multi multi2">
                                <div class="row">
                                    ...
                                    <div class="col-sm-3 w3l">
                                        <a href="{{url('/hold')}}"><img src="{{asset('/front')}}/images/me2.png" class="img-responsive" alt=""></a>
                                    </div>
                                    <div class="clearfix"></div>
                                </div>
                            </ul>
