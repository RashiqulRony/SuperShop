                ...
                <div class="col-md-3 pro-1">
                    <div class="col-m">
                        ...
                        <div class="mid-1">
                            ...
                            <div class="add">
                                <button class="btn btn-danger my-cart-btn my-cart-b" data-id="4" data-name="Mini Soya Chunks" data-summary="summary 4" data-price="3.50" data-quantity="1" data-image="{{asset('/front')}}/images/of3.png">Add to Cart</button>
                            </div>
                        </div>
                    </div>
                </div>
